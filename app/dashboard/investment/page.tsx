        ...
        <div className="p-6">
            <header className="mb-6">
                ...
                <div className="md:flex items-center justify-center md:justify-between">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            className="px-2 md:px-6 py-2 rounded-xl bg-gradient-to-b from-[#8627FF] to-[#3F1574] text-white text-base font-medium flex items-center gap-1"
            ...
            <div className="flex items-center space-x-4 overflow-x-auto text-sm mb-6">
                ...
                <button className="py-1 px-3 rounded border border-gray-200 hover:bg-gray-50 text-gray-600">
                    Bitcoin Trust Fund <span className="ml-1 text-gray-500">65</span>
                </button>
                <button className="py-1 px-3 rounded border border-gray-200 hover:bg-gray-50 text-gray-600">
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody>
                            <tr className="border-b last:border-0">
                                ...
                                <td className="cursor-pointer relative group">
